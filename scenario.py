...
class ExampleScenario(ScenarioTemplate):
    ...
    def setup_scenario(self, articulation, object_prim):
        ...
        # Store initial cube position (Isaac Sim 5.0 API - returns arrays)
    ...
    def _update_cube_position(self):
        ...
        # Set cube position (Isaac Sim 5.0 API - requires arrays)
        position = np.array([x, y, z])
        self._object.set_world_poses(positions=np.array([position]))